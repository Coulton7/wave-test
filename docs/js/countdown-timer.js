...
//All buttons
var startBtn = document.querySelector(".item.active .start");
var stopBtn = document.querySelector(".item.active .stop");
const mediaCarousel = document.querySelectorAll(".media-carousel-block");
var timer = document.querySelector(".item.active #base-timer-path-remaining");
