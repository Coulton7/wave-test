...
function carouselNormalization() {
    ...
    function normalizeHeights() {
      ...
      document.querySelectorAll('#carousel-fade .carousel-inner .carousel-item').forEach(function () {
        document.getElementsByClassName('#carousel-fade .carousel-inner .carousel-item').style.minHeight = tallest + 'px';
      });
    }
    normalizeHeights();
    ...
    window.addEventListener('resize orientationchange', function () {
      ...
      document.querySelectorAll('#carousel-fade .carousel-inner .carousel-item').forEach(function () {
        document.getElementsByClassName('#carousel-fade .carousel-inner .carousel-item').style.minHeight = '0';
      });
      normalizeHeights();
    });
}
