...
function carouselNormalization() {
    ...
    function normalizeHeights() {
      ...
      document.querySelectorAll('#carousel-fade .carousel-inner .carousel-item').forEach(function () {
        document.querySelectorAll('#carousel-fade .carousel-inner .carousel-item').css('min-height', tallest + 'px');
      });
    }
    normalizeHeights();
    ...
    window.addEventListener('resize orientationchange', function () {
      ...
      document.querySelectorAll('#carousel-fade .carousel-inner .carousel-item').forEach(function () {
        document.querySelectorAll('#carousel-fade .carousel-inner .carousel-item').css('min-height', '0');
      });
      normalizeHeights();
    });
}
